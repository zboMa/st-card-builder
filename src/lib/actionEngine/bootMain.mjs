...
var MAIN_NOVEL_BINDINGS = [
  ...
  { id: 'story.chapter.write', elId: 'btnSsWrite' },
  { id: 'story.chapter.write', elId: 'btnSsWriteNext' },
  { id: 'story.chapter.write', elId: 'btnSsWriteQa' },
  { id: 'story.chapter.write', elId: 'btnSsWriteRewrite' },
  { id: 'story.chapter.batch', elId: 'btnSsWriteBatch' },
