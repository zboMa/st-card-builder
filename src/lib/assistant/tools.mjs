...
export const ASSISTANT_TOOLS = [
  ...
  { name: 'novel_sync_outputs', kind: 'write', risk: 'confirm', summary: '模块内同步到卡（character|character_worldbook|worldbook|style|entities）', argsHint: '{ target?, selected?, policy?, ids?, names? }' },
  { name: 'apply_novel_result_to_card', kind: 'write', risk: 'confirm', summary: '同步小说产出到角色设定/主世界书（文风→「文风」条目）', argsHint: '{ target?, policy? }' },
