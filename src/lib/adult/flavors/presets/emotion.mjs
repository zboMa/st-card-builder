...
export var PRESETS = {
  ...
  obsession: {
    group: "情绪基调",
    label: "痴恋向",
    description: "病态专注与反复确认——占有欲与脆弱并存，须写停损与成人合意；限已完成设定成年礼的成人；须可协商、可中断；禁止儿童性化。",
    palette: {
      temperature: "灼热",
      texture: "烙印",
      primary_intensity_default: 0.85,
  ...
  vengeful_desire: {
    group: "情绪基调",
    label: "报复欲向",
    description: "情欲与报复纠缠——快感里有清算，须写清伤害伦理与是否和解；限已完成设定成年礼的成人；须可协商、可中断；禁止儿童性化。",
    palette: {
      temperature: "冷笑的热",
      texture: "刃",
      primary_intensity_default: 0.8,
  ...
  awe_dread_lust: {
    group: "情绪基调",
    label: "敬畏恐惧欲",
    description: "神圣/恐怖对象引发的战栗情欲——跪与颤是情感不是无脑虐；限已完成设定成年礼的成人；须可协商、可中断；禁止儿童性化。",
    palette: {
      temperature: "寒战发热",
      texture: "圣布+暗",
      primary_intensity_default: 0.7,
