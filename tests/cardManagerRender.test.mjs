...
import { createDefaultCardState, DRAFTS_KEY, CURRENT_KEY } from '../src/lib/card-builder/state.mjs';
...
describe('cardManager render after split', function() {
  it('cardManagerRender 导入 draftDisplayName / DRAFTS_KEY / 版本函数', function() {
    ...
    assert.match(src, /import \{[^}]+\bDRAFTS_KEY\b[^}]+\} from '\.\.\/state\.mjs'/);
